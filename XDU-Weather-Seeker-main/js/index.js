...
function fetchWeather(nowpoint) {
    // 获取输入框中的位置信息
    // 设置 API 密钥
    var apiKey = "d675fbc45c8a4cd4b07fa9a54c83a7d0";
    // 构建天气 API 请求 URL
    var weatherApiUrl = "https://nj4nmrhta9.re.qweatherapi.com/v7/weather/now?location=" + nowpoint + "&key=" + apiKey;
    // 构建空气质量 API 请求 URL
    var airApiUrl = "https://nj4nmrhta9.re.qweatherapi.com/v7/air/now?location=" + nowpoint + "&key=" + apiKey;
